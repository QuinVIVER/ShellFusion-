...
def codeMatcher_docSySim(matrix1, matrix2, idf1, idf1_weight, idf2):
    """
    ...
    if matrix1 is not None and matrix2 is not None \
        ...
        #TODO: 把word importance塞进去
        sim21 = (idf1_weight * (matrix1.dot(matrix2.T).max(axis=1))).sum() / idf1.sum()  # asy(2->1)
