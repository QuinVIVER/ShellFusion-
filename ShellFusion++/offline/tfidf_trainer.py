...
def computeTFIDFforTopk(tfidf_input, saved_dict_file):
    dictionary = loadDictionary(saved_dict_file)
    corpus = MyCorpus(tfidf_input, dictionary)
...
def train(tfidf_input, saved_dict_file,
    ...
    dictionary.save(saved_dict_file)
    ...
    corpora.MmCorpus.serialize(serialized_corpus_file, corpus)
...
def loadDictionary(saved_dict_file):
    ...
    return corpora.Dictionary.load(saved_dict_file)
...
def deserializeCorpus(serialized_corpus_file):
    ...
    return corpora.MmCorpus(serialized_corpus_file)
...
def loadModel(saved_model_file):
    ...
    return models.TfidfModel.load(saved_model_file)
...
def loadIndex(saved_index_file):
    ...
    return similarities.SparseMatrixSimilarity.load(saved_index_file)
